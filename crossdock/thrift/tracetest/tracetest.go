...
func (p *Downstream) Equals(other *Downstream) bool {
	...
	if p.ServerRole != other.ServerRole {
		return false
	}
	...
	if p.Transport != other.Transport {
		return false
	}
	if !p.Downstream.Equals(other.Downstream) {
		return false
	}
	return true
}
...
func (p *StartTraceRequest) Equals(other *StartTraceRequest) bool {
	...
	if p.Sampled != other.Sampled {
		return false
	}
	if p.Baggage != other.Baggage {
		return false
	}
	if !p.Downstream.Equals(other.Downstream) {
		return false
...
func (p *TraceResponse) Equals(other *TraceResponse) bool {
	...
	if !p.Span.Equals(other.Span) {
		return false
	}
	if !p.Downstream.Equals(other.Downstream) {
		return false
	}
	if p.NotImplementedError != other.NotImplementedError {
		return false
	}
	return true
}
